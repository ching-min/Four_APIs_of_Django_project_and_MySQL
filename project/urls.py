...
urlpatterns = [
	...
	path('api/articles/delete/', ArticleDeleteView.as_view(), name='article-delete'), # delete an article, search by date
	path('api/articles/update/', ArticleUpdateView.as_view(), name='article-update'), # modify an article, search by date
	path('api/articles/retrieve/', ArticleRetrieveView.as_view(), name='article-retrieve'), # retrieve the content of article, search by date
